...
DATA_TYPES = [
    "client_profiles", "project_details", "resource_profiles", "allocation",
    "billability", "billing_rates", "ctc_loaded_cost", "project_margin",
    "non_human_costs", "shadow_assignments", "resource_availability",
    "bench_data", "invoicing", "worklogs", "alerts",
]

# See shared/ACCESS-MATRIX.md — 7 roles x 15 data_types = 105 rows
PERMISSIONS: dict[str, dict[str, tuple[str, str, bool]]] = {
    "CEO": {
        "client_profiles": ("EDIT", "ALL", False), "project_details": ("EDIT", "ALL", False),
        "resource_profiles": ("EDIT", "ALL", False), "allocation": ("EDIT", "ALL", False),
        "billability": ("EDIT", "ALL", False), "billing_rates": ("VIEW", "ALL", False),
        "ctc_loaded_cost": ("VIEW", "ALL", False), "project_margin": ("VIEW", "ALL", False),
        "non_human_costs": ("EDIT", "ALL", False), "shadow_assignments": ("VIEW", "ALL", False),
        "resource_availability": ("VIEW", "ALL", False), "bench_data": ("VIEW", "ALL", False),
        "invoicing": ("VIEW", "ALL", False), "worklogs": ("VIEW", "ALL", False),
    ...
    "FINANCE": {
        "client_profiles": ("VIEW", "ALL", False), "project_details": ("VIEW", "ALL", False),
        "resource_profiles": ("VIEW", "ALL", False), "allocation": ("VIEW", "ALL", False),
        "billability": ("VIEW", "ALL", False), "billing_rates": ("VIEW", "ALL", False),
        "ctc_loaded_cost": ("VIEW", "ALL", False), "project_margin": ("VIEW", "ALL", False),
        "non_human_costs": ("EDIT", "ALL", False), "shadow_assignments": ("VIEW", "ALL", False),
        "resource_availability": ("VIEW", "ALL", False), "bench_data": ("VIEW", "ALL", False),
        "invoicing": ("EDIT", "ALL", False), "worklogs": ("NONE", "ALL", False),
        "alerts": ("VIEW", "ALL", False),
    },
    "HR": {
        "client_profiles": ("VIEW", "ALL", False), "project_details": ("VIEW", "ALL", False),
        "resource_profiles": ("EDIT", "ALL", False), "allocation": ("VIEW", "ALL", False),
        "billability": ("NONE", "ALL", False), "billing_rates": ("NONE", "ALL", False),
        "ctc_loaded_cost": ("NONE", "ALL", False), "project_margin": ("NONE", "ALL", False),
        "non_human_costs": ("NONE", "ALL", False), "shadow_assignments": ("NONE", "ALL", False),
        "resource_availability": ("VIEW", "ALL", False), "bench_data": ("VIEW", "ALL", False),
        "invoicing": ("NONE", "ALL", False), "worklogs": ("NONE", "ALL", False),
        "alerts": ("VIEW", "ALL", False),
    },
    "ENGINEER": {
        "client_profiles": ("NONE", "ALL", False), "project_details": ("NONE", "ALL", False),
        ...
        "non_human_costs": ("NONE", "ALL", False), "shadow_assignments": ("NONE", "ALL", False),
        "resource_availability": ("VIEW", "ALL", False), "bench_data": ("VIEW", "ALL", False),
        "invoicing": ("NONE", "ALL", False), "worklogs": ("EDIT", "SELF_ONLY", False),
...
async def _seed_system_config(db: AsyncSession) -> None:
    for key, value, description in SYSTEM_CONFIG:
        ...
        if existing.scalar_one_or_none() is None:
            db.add(
                SystemConfig(id=uuid.uuid4(), key=key, value=value, description=description)
            )
