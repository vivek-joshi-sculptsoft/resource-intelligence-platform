...
|------|--------|--------|---------|-------------|
| EP-0: Project Bootstrap & DevOps | — | 0 | 9 | 22 |
...
| **Total** | | **6 sprints** | **69** | **180** |

## Sprint Plan Summary

| Sprint | Theme | Epics | SP | Deliverable |
|--------|-------|-------|---|-------------|
| 0 | Bootstrap | EP-0, EP-8 (table+wrapper) | 22 | Runnable project. `docker-compose up` boots everything with seeded DB. CI runs. SQLite for local dev. |
...
|------|--------|---------|---|
| [sprint-0-bootstrap.md](sprint-0-bootstrap.md) | Sprint 0 — Project Bootstrap | 9 | 22 |
